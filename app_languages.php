...
$text['button-search']['he-il'] = "חיפוש";
$text['button-search']['it-it'] = "Cerca";
$text['button-search']['ja-jp'] = "検索";
$text['button-search']['ka-ge'] = "ძებნა";
$text['button-search']['ko-kr'] = "검색";
$text['button-search']['nl-nl'] = "Zoeken";
$text['button-search']['pl-pl'] = "Szukaj";
...
$text['button-continue']['ar-eg'] = "متابعة";
$text['button-continue']['de-at'] = "Weiter";
$text['button-continue']['de-ch'] = "Weiter";
$text['button-continue']['de-de'] = "Weiter";
$text['button-continue']['el-gr'] = "Συνέχεια";
...
$text['button-continue']['ja-jp'] = "続行";
$text['button-continue']['ka-ge'] = "გაგრძელება";
$text['button-continue']['ko-kr'] = "계속";
...
$text['button-continue']['ro-ro'] = "Continuă";
$text['button-continue']['ru-ru'] = "Продолжить";
$text['button-continue']['sv-se'] = "Fortsätt";
$text['button-continue']['tr-tr'] = "Devam Et";
$text['button-continue']['uk-ua'] = "Продовжити";
$text['button-continue']['zh-cn'] = "继续";

$text['button-storage_usage']['ar-eg'] = "استخدام التخزين";
$text['button-storage_usage']['de-at'] = "Speichernutzung";
$text['button-storage_usage']['de-ch'] = "Speichernutzung";
$text['button-storage_usage']['de-de'] = "Speichernutzung";
$text['button-storage_usage']['el-gr'] = "Χρήση αποθήκευσης";
$text['button-storage_usage']['en-gb'] = "Storage Usage";
$text['button-storage_usage']['en-us'] = "Storage Usage";
$text['button-storage_usage']['es-cl'] = "Uso de almacenamiento";
$text['button-storage_usage']['es-mx'] = "Uso de almacenamiento";
$text['button-storage_usage']['fr-ca'] = "Utilisation du stockage";
$text['button-storage_usage']['fr-fr'] = "Utilisation du stockage";
$text['button-storage_usage']['he-il'] = "שימוש באחסון";
$text['button-storage_usage']['it-it'] = "Utilizzo dello spazio di archiviazione";
$text['button-storage_usage']['ja-jp'] = "ストレージ使用量";
$text['button-storage_usage']['ka-ge'] = "საცავის გამოყენება";
$text['button-storage_usage']['ko-kr'] = "저장소 사용량";
$text['button-storage_usage']['nl-nl'] = "Opslaggebruik";
$text['button-storage_usage']['pl-pl'] = "Wykorzystanie pamięci";
$text['button-storage_usage']['pt-br'] = "Uso de armazenamento";
$text['button-storage_usage']['pt-pt'] = "Utilização de armazenamento";
$text['button-storage_usage']['ro-ro'] = "Utilizare stocare";
$text['button-storage_usage']['ru-ru'] = "Использование хранилища";
$text['button-storage_usage']['sv-se'] = "Lagringsanvändning";
$text['button-storage_usage']['tr-tr'] = "Depolama Kullanımı";
$text['button-storage_usage']['uk-ua'] = "Використання сховища";
$text['button-storage_usage']['zh-cn'] = "存储使用情况";
...
$text['label-run']['ar-eg'] = "تشغيل";
$text['label-run']['de-at'] = "Ausführen";
$text['label-run']['de-ch'] = "Ausführen";
$text['label-run']['de-de'] = "Ausführen";
$text['label-run']['el-gr'] = "Εκτέλεση";
$text['label-run']['en-gb'] = "Run";
$text['label-run']['en-us'] = "Run";
$text['label-run']['es-cl'] = "Ejecutar";
$text['label-run']['es-mx'] = "Ejecutar";
$text['label-run']['fr-ca'] = "Exécuter";
$text['label-run']['fr-fr'] = "Exécuter";
$text['label-run']['he-il'] = "הפעל";
$text['label-run']['it-it'] = "Esegui";
$text['label-run']['ja-jp'] = "実行";
$text['label-run']['ka-ge'] = "გაშვება";
$text['label-run']['ko-kr'] = "실행";
$text['label-run']['nl-nl'] = "Uitvoeren";
$text['label-run']['pl-pl'] = "Uruchom";
$text['label-run']['pt-br'] = "Executar";
$text['label-run']['pt-pt'] = "Executar";
$text['label-run']['ro-ro'] = "Rulează";
$text['label-run']['ru-ru'] = "Запустить";
$text['label-run']['sv-se'] = "Kör";
$text['label-run']['tr-tr'] = "Çalıştır";
$text['label-run']['uk-ua'] = "Запустити";
$text['label-run']['zh-cn'] = "运行";

$text['label-run_now']['ar-eg'] = "تشغيل الآن";
$text['label-run_now']['de-at'] = "Jetzt ausführen";
$text['label-run_now']['de-ch'] = "Jetzt ausführen";
$text['label-run_now']['de-de'] = "Jetzt ausführen";
$text['label-run_now']['el-gr'] = "Εκτέλεση τώρα";
$text['label-run_now']['en-gb'] = "Run Now";
$text['label-run_now']['en-us'] = "Run Now";
$text['label-run_now']['es-cl'] = "Ejecutar ahora";
$text['label-run_now']['es-mx'] = "Ejecutar ahora";
$text['label-run_now']['fr-ca'] = "Exécuter maintenant";
$text['label-run_now']['fr-fr'] = "Exécuter maintenant";
$text['label-run_now']['he-il'] = "הפעל כעת";
$text['label-run_now']['it-it'] = "Esegui ora";
$text['label-run_now']['ja-jp'] = "今すぐ実行";
$text['label-run_now']['ka-ge'] = "ახლავე გაშვება";
$text['label-run_now']['ko-kr'] = "지금 실행";
$text['label-run_now']['nl-nl'] = "Nu uitvoeren";
$text['label-run_now']['pl-pl'] = "Uruchom teraz";
$text['label-run_now']['pt-br'] = "Executar agora";
$text['label-run_now']['pt-pt'] = "Executar agora";
$text['label-run_now']['ro-ro'] = "Rulează acum";
$text['label-run_now']['ru-ru'] = "Запустить сейчас";
$text['label-run_now']['sv-se'] = "Kör nu";
$text['label-run_now']['tr-tr'] = "Şimdi Çalıştır";
$text['label-run_now']['uk-ua'] = "Запустити зараз";
$text['label-run_now']['zh-cn'] = "立即运行";
